...
* **Framework:** Flutter
* **Language:** Dart
* **Communication:** Bluetooth Classic (SPP standard)
* **State Management:** Provider
* **IDE:** Visual Studio Code

## 🏁 How to Run the Project

To compile and run this project locally, you will need the **Flutter SDK** and an **IDE** (like VS Code) properly configured.
...
3.  **Run the app:**
    * Make sure you have an Android device connected and **ADB** working, or an emulator running.
    ```bash
    flutter run
    ```
...
The final product of this project includes:

* **Source Code:** All Flutter/Dart source code available in this repository.
* **Android App:** The `app-release.apk` executable file for direct installation.
* **Documentation:** Project and usage documentation.
